...
/***/ function(module, exports, __webpack_require__) {
	...
	var candidates_1 = __webpack_require__(342);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(4);
	var wholitical_service_1 = __webpack_require__(343);
	var router_deprecated_1 = __webpack_require__(301);
	var Candidates = (function () {
	    ...
	    Candidates = __decorate([
	        ...
	        __metadata('design:paramtypes', [wholitical_service_1.Wholitical, router_deprecated_1.RouteParams])
	    ], Candidates);
	    return Candidates;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http_1 = __webpack_require__(280);
	__webpack_require__(339);
	var Wholitical = (function () {
	    function Wholitical(http) {
	        this.http = http;
	    }
	    Wholitical.prototype.getCandidatesByZip = function (zip) {
	        return this.makeRequest("api/candidates/" + zip);
	    };
	    Wholitical.prototype.makeRequest = function (path) {
	        var params = new http_1.URLSearchParams();
	        params.set('per_page', '100');
	        var url = "/" + path;
	        return this.http.get(url, { search: params })
	    ...
	    Wholitical = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [http_1.Http])
	    ], Wholitical);
	    return Wholitical;
	}());
	exports.Wholitical = Wholitical;
